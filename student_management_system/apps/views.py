...
def student_delete(request, pk):
    ...
    try:
        ...
        messages.error(request, f'Error deleting student: {e!s}')
...
def teacher_edit(request, pk):
    ...
    if request.method == 'POST':
        try:
            ...
            messages.error(request, f'Error updating teacher: {e!s}')
...
def teacher_delete(request, pk):
    ...
    try:
        ...
        messages.error(request, f'Error deleting teacher: {e!s}')
    return redirect('teacher_list')
...
def fee_structure_add(request):
    if request.method == 'POST':
        try:
            ...
            messages.error(request, f'Error adding fee structure: {e!s}')
...
def fee_structure_edit(request, pk):
    ...
    if request.method == 'POST':
        try:
            ...
            messages.error(request, f'Error updating fee structure: {e!s}')
...
def fee_structure_delete(request, pk):
    ...
    try:
        ...
        messages.error(request, f'Error deleting fee structure: {e!s}')
    return redirect('fee_structure_list')
